...
@section('title', trans('message.terms_conditions'))
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{trans('message.terms_conditions')}}  <small>{{ trans('message.terms_conditions_content') }}</small>
                            @php
                            $type1 = str_replace('-', '_', $type);
                            @endphp
                            <a href="{{url('settings') .'/'. $type1}}" target="_blank" class="float-end btn btn-sm btn-theme">{{trans('message.terms_conditions_page')}}</a>
                        </h5>
                    </div>
                    <div class="card-body">
