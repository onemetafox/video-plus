...
@section('title', trans('message.privacy_policy'))
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{trans('message.privacy_policy')}}  <small>{{ trans('message.privacy_policy_content') }}</small>
                            @php
                            $type1 = str_replace('-', '_', $type);
                            @endphp
                            <a href="{{url('settings') .'/'. $type1}}" target="_blank" class="float-end btn btn-sm btn-theme">{{trans('message.privacy_policy_page')}}</a>
                        </h5>
                    </div>
                    <div class="card-body">
