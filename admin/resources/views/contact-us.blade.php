...
@section('title', trans('message.contact_us'))
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{trans('message.contact_us')}}  <small>{{ trans('message.contact_us_content') }}</small>
                            @php
                            $type1 = str_replace('-', '_', $type);
                            @endphp
                            <a href="{{url('settings') .'/'. $type1}}" target="_blank" class="float-end btn btn-sm btn-theme">{{trans('message.contact_us_page')}}</a>
                        </h5>
                    </div>
                    <div class="card-body">
